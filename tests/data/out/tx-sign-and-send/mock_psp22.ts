...
export default class Methods {
	...
	"FlashLender::flash_fee" (
		...
		return txSignAndSend( this.__nativeContract, this.__keyringPair, "flashLender::flashFee", [token, amount], __options );
	}
	/** */
	"Pausable::paused" (
		__options ? : GasLimit,
	...
	"Ownable::owner" (
		...
		return txSignAndSend( this.__nativeContract, this.__keyringPair, "ownable::owner", [], __options );
	}
	/** */
