...
async function main() {
	...
	const mintTx = await contract.tx['PSP34Mintable::mint'](aliceKeyringPair.address, IdBuilder.U8(1));

	const totalSupplyAfterMint = await contract.query['PSP34::total_supply']();
	const balanceAfterMint = await contract.query['PSP34::balance_of'](aliceKeyringPair.address);
