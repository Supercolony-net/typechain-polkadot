...
export type InvestmentDetails = {
	...
	investment_tokens_amount: (string | number),
	lending_token: AccountId,
	total_amount_to_be_raised: (string | number),
	total_partitions_to_be_purchased: (string | number),
	partitions_requested: (string | number),
	extra_info: Hash
}
