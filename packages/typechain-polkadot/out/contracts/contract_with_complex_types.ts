...
import ABI from '../../artifacts/contract_with_complex_types.json';
import QueryMethods from '../query/contract_with_complex_types';
import BuildExtrinsicMethods from '../build-extrinsic/contract_with_complex_types';
import TxSignAndSendMethods from '../tx-sign-and-send/contract_with_complex_types';
import MixedMethods from '../mixed-methods/contract_with_complex_types';
