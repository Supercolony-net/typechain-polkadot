...
export default class Methods {
	...
	"cap" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "cap", [], __options);
	}
	...
	"get_complex_struct_1" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getComplexStruct1", [], __options);
	}
	...
	"get_complex_struct_2" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getComplexStruct2", [], __options);
	}
	...
	"get_complex_struct_3" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getComplexStruct3", [s], __options);
	}
	...
	"get_complex_struct_4" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "getComplexStruct4", [s], __options);
	}
	...
	"PSP22Metadata::token_symbol" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "psp22Metadata::tokenSymbol", [], __options);
	}
	...
	"PSP22Metadata::token_name" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "psp22Metadata::tokenName", [], __options);
	}
	...
	"PSP22Metadata::token_decimals" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "psp22Metadata::tokenDecimals", [], __options);
	}
	...
	"FlashLender::flash_fee" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "flashLender::flashFee", [token, amount], __options);
	}
	...
	"Pausable::paused" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "pausable::paused", [], __options);
	}
