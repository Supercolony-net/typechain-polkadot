...
export default class Methods {
	...
	"mint_to" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "mintTo", [account, amount], __options);
	}
	...
	"WNative::deposit" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "wNative::deposit", [], __options);
	}
	...
	"WNative::withdraw" (
		...
		return txSignAndSend( this.__apiPromise, this.__nativeContract, this.__keyringPair, "wNative::withdraw", [value], __options);
	}
