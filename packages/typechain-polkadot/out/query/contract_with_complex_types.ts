...
export default class Methods {
	...
	"FlashLender::flashloan" (
		...
		data: ArgumentsTypes[19],
		__options ? : GasLimit,
	): Promise< QueryReturnType< OkishReturns["22"] > >{
		return queryOkJSON( this.__nativeContract, this.__callerAddress, "flashLender::flashloan", [receiverAccount, token, amount, data], __options);
	}
